...
%       set(gcf,'tag','transformserv','un','pix','pos',size+[10 10 -50 -50],'numbertitle','off',...    % LM-update
        ...
        uicontrol('sty','fr','pos',[20 90 880 20],'foreg',cc,'backg',cc);
        uicontrol('sty','fr','pos',[20 20 880 20],'foreg',cc,'backg',cc);
        uicontrol('sty','fr','pos',[550 20 20 90],'foreg',cc,'backg',cc);
        uicontrol('sty','fr','pos',[430 20 20 90],'foreg',cc,'backg',cc);
        axes('un','pix','pos',[315 200 470 40],'ycolor',fcol,'xlim',[-15 15],'xtick',[-15:3:15],'xcolor',[1 0 0],...
            'color',fcol,'XAxisLocation','top')
        axes('un','pix','pos',[300 150 485 40],'ycolor',fcol,'xlim',[0 15],'xtick',[0:1:15],...
            'xcolor',[0 0 1],'color',fcol,'tickdir','out')
